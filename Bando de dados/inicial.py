...
'''
    ...
    def conferir (self):
        ...
        if self.Iusuario.text == 'admin' and self.Isenha.text == 'univesp':
            print(self.Iusuario.text)
            print(self.Isenha.text)
            self.Vusuario.text = 'Ok'
            self.Vsenha.text = 'Ok'
        else:
            self.Vusuario.text = 'Incorreto'
            self.Vsenha.text = 'Incoreto'
